...
-   `format` **[String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** Format of the request (json|form|buffer). (optional, default `"json"`)
